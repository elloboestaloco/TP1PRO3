...
namespace TP
{
    public partial class ListarPersonas : Form
    {
        ...
        private void ListarPersonas_Load(object sender, EventArgs e)
        {
            ...
            listaBindeable = new BindingList<Personas>(ListaPersonas);
        ...
        {
            txtApellido.Text = PersonEdit.Apellido;
            txtNombre.Text = PersonEdit.Nombre;
            dtmEdad.Value = PersonEdit.FechaNacimiento;
            if (PersonEdit.Sexo == "Masculino") rdioMasculino.Checked = true;
            if (PersonEdit.Sexo == "Femenino") rdioFemenino.Checked = true;
            if (PersonEdit.Sexo == "Otro") rdioOtro.Checked = true;
            if (PersonEdit.Gustos.Find(x => x == "Reggea") == "Reggea") ckbReggea.Checked = true;
            if (PersonEdit.Gustos.Find(x => x == "Cumbia") == "Cumbia") ckbCumbia.Checked = true;
            if (PersonEdit.Gustos.Find(x => x == "Rap") == "Rap") ckbRap.Checked = true;
            if (PersonEdit.Gustos.Find(x => x == "Pop") == "Pop") ckbPop.Checked = true;
            if (PersonEdit.Gustos.Find(x => x == "Cuarteto") == "Cuarteto") ckbCuarteto.Checked = true;
            if (PersonEdit.Gustos.Find(x => x == "Rock") == "Rock") ckbRock.Checked = true;
            cboColor.SelectedItem = PersonEdit.Color;
        }
        private void BtnModificar_Click(object sender, EventArgs e)
        {
            ...
            this.PersonEdit = (Personas)Select;
            this.setEdit();
            this.edit = true;
        }
        private void BorrarSelected()
        {
            ...
            ListaPersonas.Remove(PersonEdit);
            this.refrescarGrilla();
